...
$(window).on('load', function (event) {
  // Desabilitar campos samurai
  $('#kekkei-genkai').attr('disabled', true);
  $('#cla').attr('disabled', true);
  $('#elemento-basico').attr('disabled', true);
  $('#elemento-avancado').attr('disabled', true); // Esconder tipos das qualidades e defeitos
  ...
  $('#enviar').on('click', function (event) {
    ...
    var kenjutsu = $('#kenjutsu').val();
    var bojutsu = $('#bojutsu').val();
    var kyujutsu = $('#kyujutsu').val();
    ...
    $.post('/post', {
      ...
      localStorage.setItem("samurai", true);
      location.href = '/forum';
    }).fail(function () {
